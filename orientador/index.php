...
<head>
    ...
    <title>Dashboard do Orientador - <?php echo APP_NAME; ?></title>
...
<body class="bg-light">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo BASE_URL; ?>/admin/dashboard/orientador/">
    ...
    <main class="container my-4">
        <h2 class="mb-4">Dashboard do Orientador</h2>
                                ...
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="<?php echo BASE_URL; ?>/documentos.php?projeto_id=<?php echo $projeto['id']; ?>" class="btn btn-info btn-sm">
                                                <i class="fas fa-file-alt me-1"></i>Documentos
                                            </a>
                                        </div>
                                    </div>
