...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nome) || empty($email) || empty($departamento) || empty($area_especializacao) || empty($senha)) {
        ...
        if ($stmt->fetch()) {
            ...
            try {
                $stmt = $conn->prepare("INSERT INTO usuarios (nome, email, senha, tipo_usuario, departamento, area_especializacao, status) VALUES (?, ?, ?, 'orientador', ?, ?, TRUE)");
                ...
                $error = 'Erro ao cadastrar orientador. Por favor, tente novamente.';
            }
        }
        $db->closeConnection();
    }
...
<head>
    ...
    <title>Cadastrar Orientador - <?php echo APP_NAME; ?></title>
    ...
    <style>
        ...
        .sidebar{
            background-color: #91530c !important;
        }
    </style>
</head>
  <body>
...
-         <!-- Sidebar -->
-         <div class="sidebar" style="background-color: #91530c" >
        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="orientadores.php" class="btn btn-secondary">
                        ...
                        <form method="POST" action="" class="needs-validation" novalidate>
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Cadastrar Orientador
                                </button>
                            </div>
                        </form>
                    </div>
